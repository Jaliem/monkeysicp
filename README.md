...
Step 2 & 3: Configure and Launch
After setup, you’ll need to configure your environment and start the system.
...
Doctor API: http://localhost:8001
Pharmacy API: http://localhost:8002
Wellness API: http://localhost:8003
⚡ Need Help?
Common Issues
